...
export interface ProviderGroupAccountRelationDto {
  id?: string; // Relation ID
  accountTokenId: string;
  accountTokenName?: string; // Output only
  weight: number;
  priority: number;
  isActive?: boolean;
  expiresIn?: number | null;
  tokenObtainedTime?: string | null;
