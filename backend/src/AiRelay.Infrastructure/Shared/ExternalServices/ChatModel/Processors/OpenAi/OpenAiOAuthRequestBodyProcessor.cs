...
/// </summary>
public class OpenAiOAuthRequestBodyProcessor(OpenAiCodexInjector openAiCodexInjector) : IRequestProcessor
{
    ...
    public Task ProcessAsync(DownRequestContext down, UpRequestContext up, CancellationToken ct)
    {
        ...
        if (requestJson.TryGetPropertyValue("reasoning", out var reasoningNode) &&
        ...
        openAiCodexInjector.InjectCodexInstructions(requestJson, down.GetUserAgent());
